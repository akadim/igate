...
<form action="index2.php" method="post" name="adminForm"> 
	<table width="100%">
		...
		<td width="20%" valign="top" style="padding-top:30px; padding-left:15px;">
				 ...
				 <a href="http://www.youtube.com/watch?v=_QbNrkXEa5k" target="_blank">Ho to migrate users to J! 2.5</a>				
		    ...
		    <table>
				...
				<tr>
				    <td colspan="3">
						...
						<p>ARRA User Import Export documentation: <a href="http://www.joomlarra.com/joomla-1.7-user-export-import-documentation/" title="j1.7 documentation" target="_blank">http://www.joomlarra.com/joomla-1.7-user-export-import-documentation/</a></p>
