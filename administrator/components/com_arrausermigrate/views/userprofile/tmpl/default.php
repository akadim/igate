...
<form method="post" name="adminForm" id="adminForm">
	...
	?>
		...
		<?php
			echo $tabs->endPanel();
			echo $tabs->startPanel(JText::_("ARRA_ADD_FIELDS_PROFILE"), 'add-panel');			
		?>
						...
						<td>
							<table style="margin:auto;">
								...
								?>
										<tr>
											<td>
												<div id="column<?php echo $i; ?>" style="display:none; background-color:#E9E9E9; border-bottom:1px solid #E9E9E9; border-right:1px solid #E9E9E9; color:#666666; font-weight:bold; padding:5px;">
													<table>
														<tr>
															<td valign="top">
															...
															<td valign="top">
																<?php echo JText::_("ARRA_FIELD_TYPE")."<br />".$this->getFieldType($i); ?>
															</td>
															<td valign="top">
															...
															<td valign="top">
																...
																<?php echo JText::_("ARRA_FIELD_LABEL"); ?><br /><input type="text" id="field_label_<?php echo $i; ?>" name="field_label_<?php echo $i; ?>" value="" style="float:none !important;" />														
															</td>
															<td valign="top">
																<?php echo JText::_("ARRA_FIELD_MESSAGE"); ?><br /><input type="text" id="field_message_<?php echo $i; ?>" name="field_message_<?php echo $i; ?>" value="" style="float:none !important;" />														
															</td>
															...
															<td valign="top" id="td_cols_<?php echo $i; ?>" style="display:none;">
																<?php echo JText::_("ARRA_FIELD_COLS"); ?><br /><input type="text" id="field_cols_<?php echo $i; ?>" name="field_cols_<?php echo $i; ?>" value="" style="float:none !important;" size="5" />														
															</td>
															<td valign="top" id="td_rows_<?php echo $i; ?>" style="display:none;">
																<?php echo JText::_("ARRA_FIELD_ROWS"); ?><br /><input type="text" id="field_rows_<?php echo $i; ?>" name="field_rows_<?php echo $i; ?>" value="" style="float:none !important;" size="5" />														
															</td>
															<td valign="top" id="td_size_<?php echo $i; ?>" style="display:block;">
																<?php echo JText::_("ARRA_FIELD_SIZE"); ?><br /><input type="text" id="field_size_<?php echo $i; ?>" name="field_size_<?php echo $i; ?>" value="" style="float:none !important;" size="5" />														
															</td>
														</tr>
													</table>
												</div>
